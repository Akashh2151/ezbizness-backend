...
import jwt
from model.auth_schema import User
import logging
from security.auth_validation import phone_number,email_regex,password_regex
...
def register_step1():
    try:
        ...
        required_fields = [name, email, password, mobile,businessType,confirmPassword]
